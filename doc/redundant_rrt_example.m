...
%% Getting started
% Create *main_redundant_rrt.m* file. You can create m-file with any other name, that is
...
%% Sources of *main_redundant_rrt.m*
% Press 
% <matlab:edit('examples/main_redundant_rrt.m') here>
